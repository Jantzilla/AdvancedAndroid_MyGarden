...
import static com.example.android.mygarden.provider.PlantContract.PATH_PLANTS;
    ...
    public class PlantWateringService extends IntentService {
        ...
        // COMPLETED (1): Change ACTION_WATER_PLANT to ACTION_WATER_PLANT and
        ...
        public static void startActionWaterPlant(Context context, long plantId) {
            Intent intent = new Intent(context, com.example.android.mygarden.PlantWateringService.class);
